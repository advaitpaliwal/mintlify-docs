...
<AccordionGroup>
  <Accordion icon="github" title="Clone your docs locally">
    ...
    [dashboard](https://dashboard.reminisc.ai). To clone the repository locally,
    follow these
...
<Accordion icon="message-bot" title="Install our Github app">
  ...
  your [dashboard](https://dashboard.reminisc.ai). Once the bot has been
...
<Accordion icon="rocket" title="Push your changes">
  ...
  update your docs through our [dashboard](https://dashboard.reminisc.ai).
</Accordion>
